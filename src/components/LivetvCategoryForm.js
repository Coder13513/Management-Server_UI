...
export class LivetvCategoryForm extends Component {
        ...
        return (
            <div>
                ...
                <h2>LivetvCategory </h2>
                    ...
                    <div class="form-group row" >
                        <label class="col-sm-3 col-form-label" for="file">Publish:</label>
                        <div class="col-sm-7">
                            <input type="checkbox" class="mycheck" />
                        </div>
                    </div>
...
export default LivetvCategoryForm;
