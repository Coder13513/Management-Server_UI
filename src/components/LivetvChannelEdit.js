...
select() {
    ...
    editArchive = (Id) => {
        ...
        this.setState({
            ...
            channel_url: editingItem.channel_url,
            channel_image: editingItem.channel_image,
            EPG_file: editingItem.EPG_file,
    ...
    updateHandler = (e) => {
        ...
        axios({
            method: 'PUT',
            url: API_PATH.URL + "livetv/channels/" + id ,
                        headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer'+ticket             },
            data: fd
    ...
    render() {
        const { name, channel_image, category,categoryL, channel_url, EPG_file, description, } = this.state
