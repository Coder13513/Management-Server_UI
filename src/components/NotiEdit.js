...
export class ArchiveEdit extends Component {
    ...
    editArchive = (Id) => {
        ...
        this.setState({
            ...
            subscription: editingItem.subscription,
            package: editingItem.package,
            title: editingItem.title,
            image_content: editingItem.image_content,
            text_content: editingItem.text_content,
            notify_time: editingItem.notify_time,
            reoccurance: editingItem.reoccurance,
            read_status: editingItem.read_status,
    ...
    updateHandler = (e) => {
        ...
        axios({
            method: 'PUT',
            url: API_PATH.URL + "notification/" + id + '/',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer' + ticket
            },
    ...
    let optionItmesP = (Archives.map = ((arch) =>
        ...
        const archivesItems = this.state.Archives.map(Archive => {
            return (
                <li key={Archive.id}>{Archive.title}
