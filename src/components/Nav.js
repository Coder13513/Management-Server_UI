                    ...
                    <div class="col-sm-2" >
                        <div className="sidebar">
                            <div className="btn-group-vertical">
                                ...
                                <div class="menu">
                                <Link to="/Donut">
                                        <a type="button" className="btn text-light"><i className="fa fa-home"></i> Home</a>
                                    </Link>
                                    <Link to="/Admin">
                                        <a type="button" className="btn text-light"><i className="fa fa-user-circle-o"></i> Admin</a>
                                    </Link>
                                    <Link to="/Subscriber">
                                        <a type="button" className="btn text-light"><i className="fa fa-users"></i> Subscribers</a>
                                    </Link>
                                    <Link to="/Livetv">
                                        <a type="button" className="btn text-light"><i className="fa fa-tv"></i> Live TV</a>
                                    </Link>
                                    <Link to="/Radio">
                                        <a type="button" className="btn text-light"><i className="fa fa-music"></i> Radio</a>
                                    </Link>
                                    <Link to="/Archive">
                                    ...
                                    <Link to="/Vod">
                                        <a type="button" className="btn text-light"><i className="fa fa-youtube-play"></i> VOD</a>
                                    </Link>
                                    <Link to="/Settings">
                                        <a type="button" className="btn text-light"><i className="fa fa-gears"></i>   Settings</a>
                                    </Link>
                                </div>
                            </div>
                        </div>
