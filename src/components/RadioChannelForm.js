...
export class RadioChannelForm extends Component {
    ...
    render() {
        const { Name, image, category,categoryL, channelurl, file, description, } = this.state
            ...
            <div >
                ...
                <h2>RadioChannel </h2>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="url" class="form-control" value={channelurl} onChange={this.channelurlchange} />
                        </div>
                    </div>
...
export default RadioChannelForm;
